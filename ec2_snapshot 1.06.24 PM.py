...
two_weeks_ago_dc_cb_AWS_04_snapshot = conn_us.get_all_snapshots(filters = {"description": dc_cb_AWS_04_vol_description_two_weeks_ago})
#grab snapshot-ID (since result is in list-of-tuples format)
try:
    two_weeks_ago_all_snapshots2 = two_weeks_ago_dc_cb_AWS_04_snapshot[0]
    two_weeks_ago_all_snapshots3 = two_weeks_ago_all_snapshot.id
#delete snapshot
